    ...
    public class SimpleTerrain
    {
        ...
        public SimpleTerrain(GraphicsDevice graphicsDevice, ContentManager content)
        {
            ...
            */
            ...
            // color basico
            Texture2D colorMap = content.Load<Texture2D>(ContentFolder3D + "Terrain/colormap");
            // blend texture 1
            ...
            // cargo el heightmap
            LoadHeightmap(graphicsDevice, heightMap, 50, 4, Vector3.Zero);
        ...
        public void Draw(GameTime gameTime, Matrix view, Matrix projection)
        {
            ...
            var traslacion = new Vector3(-2920f, 350f, 70f);
            ...
            Effect.Parameters["World"].SetValue(Matrix.Identity * Matrix.CreateScale(1f, 1f, 2.11f) * Matrix.CreateRotationX(MathHelper.Pi) * Matrix.CreateRotationY(MathHelper.Pi) * Matrix.CreateScale(0.35f) * Matrix.CreateTranslation(traslacion));
