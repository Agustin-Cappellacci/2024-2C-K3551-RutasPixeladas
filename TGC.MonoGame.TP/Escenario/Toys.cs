...
namespace TGC.MonoGame.TP.Content.Models
{
    ...
    class Toys
    {
        ...
        public void DrawCollisionBoxes(Matrix viewMatrix, Matrix projectionMatrix)
        {
            ...
            // Dibujar lego
            DrawBox(Matrix.CreateFromYawPitchRoll(-(float)Math.PI /4, 0, 0)*Matrix.CreateTranslation(1200f, 2f, 1700f), new Vector3(150f, 100f, 150f)/ 2f, viewMatrix, projectionMatrix);
        }
