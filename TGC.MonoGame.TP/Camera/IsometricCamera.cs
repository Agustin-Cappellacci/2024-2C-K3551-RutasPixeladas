...
namespace TGC.MonoGame.TP.Content.Models
{
    ...
    class IsometricCamera
    {
        ...
        {
            // Orthographic camera
            Projection =  Matrix.CreateScale(0.6f) * Matrix.CreateFromYawPitchRoll(MathF.PI / 6, 0, MathF.PI / 4)  * Matrix.CreateOrthographic(screenWidth , screenHeight, -500f, 10000f);
